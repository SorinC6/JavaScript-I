...
console.log(internMitzi.first_name);
...
console.log(internGannie.first_name);
...
const parent = {
    ...
    age: 70,
    speak: function(){
        console.log(`I'm ${this.name} a parent and I can speak`);
    },
    child: {
        name: 'George',
        age: 50,
        speak: function(){
            console.log(`I'm ${this.name} a child and I can speak`);
        },
        grandchild: {
            name: 'Sam',
            age: 30,
            speak: function(){
                console.log(`I'm ${this.name} a grandchild and I can speak`);
            },
        },
    },
};
